		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFocusAccess().getGroup(), "rule__Focus__Group__0");
					put(grammarAccess.getFocusAccess().getGroup_3(), "rule__Focus__Group_3__0");
					put(grammarAccess.getAuthorAccess().getGroup(), "rule__Author__Group__0");
					put(grammarAccess.getPurposeAccess().getGroup(), "rule__Purpose__Group__0");
					...
					put(grammarAccess.getActionAccess().getDescriptionAssignment_8(), "rule__Action__DescriptionAssignment_8");
					...
					put(grammarAccess.getRealLiteralAccess().getRealAssignment_1(), "rule__RealLiteral__RealAssignment_1");
					...
					put(grammarAccess.getENVAccess().getFocusAssignment_5(), "rule__ENV__FocusAssignment_5");
					put(grammarAccess.getENVAccess().getAuthorAssignment_6(), "rule__ENV__AuthorAssignment_6");
					put(grammarAccess.getENVAccess().getPurposeAssignment_7(), "rule__ENV__PurposeAssignment_7");
					put(grammarAccess.getFocusAccess().getFocusObjectAssignment_2(), "rule__Focus__FocusObjectAssignment_2");
					put(grammarAccess.getFocusAccess().getDxAssignment_3_1(), "rule__Focus__DxAssignment_3_1");
					put(grammarAccess.getFocusAccess().getDyAssignment_3_3(), "rule__Focus__DyAssignment_3_3");
					put(grammarAccess.getFocusAccess().getDzAssignment_3_5(), "rule__Focus__DzAssignment_3_5");
					put(grammarAccess.getAuthorAccess().getAuthorStringAssignment_2(), "rule__Author__AuthorStringAssignment_2");
					put(grammarAccess.getPurposeAccess().getPurposeStringAssignment_2(), "rule__Purpose__PurposeStringAssignment_2");
