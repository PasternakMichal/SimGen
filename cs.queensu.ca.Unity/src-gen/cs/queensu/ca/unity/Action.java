...
public interface Action extends EObject
{
   ...
   * The list contents are of type {@link cs.queensu.ca.unity.Payload}.
   * <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Returns the value of the '<em><b>Return Payload</b></em>' containment reference list.
   * The list contents are of type {@link cs.queensu.ca.unity.Payload}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Return Payload</em>' containment reference list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Return Payload</em>' containment reference list.
   * @see cs.queensu.ca.unity.UnityPackage#getAction_ReturnPayload()
   * @model containment="true"
   * @generated
   */
  EList<Payload> getReturnPayload();
