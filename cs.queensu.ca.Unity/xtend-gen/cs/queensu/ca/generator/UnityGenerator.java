...
public class UnityGenerator extends AbstractGenerator {
  ...
  public CharSequence starter(final ENV e) {
    ...
    _builder.newLine();
    {
      ...
      for(final Channel k_1 : _channels) {
        _builder.append("   \t");
        _builder.append("Object.AddComponent<ChannelController");
  ...
  public CharSequence channelcontroller(final Channel c) {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class ChannelController : MonoBehaviour {");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.append(_name_1, "\t\t");
    _builder.append(",20); // port, net ID, Container size");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
